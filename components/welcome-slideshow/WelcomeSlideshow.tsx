...
import WelcomeSlideshowItem from '@/components/welcome-slideshow/SlideshowItem';
import WelcomeSlideshowPager from '@/components/welcome-slideshow/SlideshowPager';
...
const WelcomeSlideshow = () => {
  ...
  return (  
    <View style={styles.container}>
      <Animated.FlatList 
        data={data} 
        renderItem={({item, index}) => <WelcomeSlideshowItem item={item} index={index} scrollX={scrollX} />} 
        horizontal={true}
        pagingEnabled={true}
      ...
      />
      <WelcomeSlideshowPager data={data} pagerIndex={pagerIndex}/> 
    </View>
  );
}
