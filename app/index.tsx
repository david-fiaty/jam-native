...
import { setCountriesData, setOrganizationTypesData, setSectorsData, setVenueTypesData } from '@/redux/slices/AppSlice';
...
export default () => {
  ...
  useEffect(() => {
    (async () => {
      ...
      const [sectors, countries, venueTypes, organizationTypes] = await Promise.all([
